...
- [x] v0.5 Android-first native foundation — first debug APK built by GitHub Actions
- [~] v0.6 Deep Semantic Verification — active development
  - [x] fail-closed NLI provider boundary
